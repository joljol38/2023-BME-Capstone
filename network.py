...
class ConvNCF(nn.Module):
    def __init__(self, drugs_dim, sides_dim, embed_dim, bathsize, dropout1=0.8, dropout2=0.8):
        ...
        self.drug_dim = self.drugs_dim//9
    ...
    def forward(self, drug_features, side_features, device):
        ...
        drug1, drug2, drug3, drug4, drug5, drug6, drug7, drug8, drug9 = drug_features.chunk(9, 1)
        ...
        drugs = [x_drug1, x_drug2, x_drug3, x_drug4, x_drug5, x_drug6, x_drug7, x_drug8, x_drug9]
